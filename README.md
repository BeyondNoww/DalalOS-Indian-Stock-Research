...
- [`docs/OPENAI_PLUGIN_SUBMISSION.md`](docs/OPENAI_PLUGIN_SUBMISSION.md) — public-safe OpenAI Plugin listing/review preparation pack, including starter prompts and positive/negative capability tests.
